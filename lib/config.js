...
var logger = new (winston.Logger)({
  transports: [
    new (winston.transports.Console)({
      level: 'info', colorize: true, timestamp: function () {
        return Date();
      },
    })
    //,new (winston.transports.File)({ filename: INSTALLED_PATH + 'dev-log.log', level: 'error' })
  ]
});
...
const VF_CONFIG = {
  installedPath: INSTALLED_PATH,
  appEndpoint:'http://129.114.109.103:6765/verticofactory/rest/v2/entities/vertico$Applications',
  register: 'http://129.114.109.103:6765/verticofactory/rest/v2/entities/vertico$Donors',
  instanceEndpoint:'http://129.114.109.103:6765/verticofactory/rest/v2/entities/vertico$Instance',
  appLock: applockPath,
  appsData: appDataPath,
  validateAPIKey: 'http://129.114.109.103:6765/verticofactory/rest/v2/queries/vertico$Donors/getUserInfo',
  registerInstance: 'http://129.114.109.103:6765/verticofactory/rest/v2/entities/vertico$Instance',
  myapps: 'http://129.114.109.103:6765/verticofactory/rest/v2/queries/vertico$Applications/list?instanceID='
};
